<?php
 ...
 if (isset($_SESSION['id'])){
     header('Location: /all_engineering/fadmin/admin');
     exit;
}
...
if($valid){
    ...
    header('Location:QWggfasYtTrFPmmnbh347hHggjh-GFagtftf-AGttfhjtqqq-15552a@@@@@-qwwwe');
    exit;
}
...
<html lang="fr">
     ...
     <body>
<?php
include_once('../tools/nav-bar-ad.php');
?>
    <div class="container">
        <div class="row">
